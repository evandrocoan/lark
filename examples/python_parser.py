...
python_parser2 = Lark.open('python2.pushdown', parser='lalr', **kwargs)
python_parser3 = Lark.open('python3.pushdown',parser='lalr', **kwargs)
python_parser2_earley = Lark.open('python2.pushdown', parser='earley', lexer='standard', **kwargs)
