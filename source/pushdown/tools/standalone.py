...
from pushdown.parsers.lalr_analysis import Shift, Reduce
...
class TreeBuilderAtoms:
    def __init__(self, pushdown):
        self.rules = pushdown.rules
        self.ptb = pushdown._parse_tree_builder
...
def main(fobj, start):
    ...
    print('# The file was automatically generated by Pushdown v%s' % pushdown.__version__)
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Pushdown Stand-alone Generator Tool")
        print("Usage: python -m pushdown.tools.standalone <grammar-file> [<start>]")
        sys.exit(1)
