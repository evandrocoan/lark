...
class LarkOptions(object):
    ...
    OPTIONS_DOC = """
        ...
        profile - Measure run-time usage in Pushdown. Read results from the profiler property (Default: False)
...
class Lark:
    ...
    def open(cls, grammar_filename, rel_to=None, **options):
        ...
        Example:
            ...
            >>> Lark.open("grammar_file.pushdown", rel_to=__file__, parser="lalr")
            Lark(...)
